...
public class StringUtil {
     ...
     * @date 2016-4-18
     */
    public static long setBinaryIndex1(long value, final int bit, final int index) {
        final long dex = 1L;
    ...
    public static int setBinaryIndex1(int value, final int bit, final int index) {
        if (getBinaryIndex(value, bit) == 1) {
            if (index == 0) {
                value -= 1 << bit - 1;
            }
     ...
     * @date 2016-4-18
     */
    public static int getBinaryIndex1(long value, final int bit) {
        long remainder = 0;
        for (int i = 0; i < bit; i++) {
     ...
     * @date 2016-4-18
     */
    public static int getBinaryIndex1(int value, final int bit) {
        int remainder = 0;
        for (int i = 0; i < bit; i++) {
    ...
    public static Integer toInteger1(final String s, final Integer defaultValue) {
